...
<html>
<head>
<title>LoanManagement:LoanEligibilityCheck</title>
</head>
<body style="background-color:rgb(200,250,300)">

<center>
<h3 style="color:blue">LoanBazaar-Find the Best Loan For You</h3>
...
<tr>
<td>Gender</td>
<td><form:radio buttons path="gender"items="${genderList}"/></td>
